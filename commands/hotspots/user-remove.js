...
module.exports = {
	...
	async execute(message) {
		...
		return message.channel.send(`${message.author.username}#${message.author.discriminator} removed you ${mentionUser.username}#${mentionUser.discriminator} as hotspot user, you are not longer able to report hotspots`);
	},
};
